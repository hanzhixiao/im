...
type SignInReq struct {
	...
	AccountType      pb_enum.ACCOUNT_TYPE  `protobuf:"varint,1,opt,name=account_type,json=accountType,proto3,enum=pb_enum.ACCOUNT_TYPE" json:"account_type,omitempty"` // 账户类型 1:手机号 2:im账户
	...
	Account          string                `protobuf:"bytes,3,opt,name=account,proto3" json:"account,omitempty"`                                                       // 手机号/im账户
